...
// Example dynamic effect: Add a new event programmatically (optional)
const newEvent = {
  month: "JAN",
  day: "10",
  year: "2027",
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  continue1Btn.addEventListener('click', () => {
      ...
      if (!fullName.value || !email.value || !phone.value) {
          showMessage('Please fill in all required fields (Full Name, Email Address, Phone Number) before continuing.');
          return;
      }
  ...
  continue2Btn.addEventListener('click', () => {
      ...
      if (!bookingType || !preferredDate || !paymentMethod) {
          showMessage('Please select a Booking Type, Preferred Date, and Payment Method.');
          return;
      }
  ...
  bookingForm.addEventListener('submit', (e) => {
      ...
      if (!paymentProof.files.length) {
          showMessage('Please upload your payment proof before confirming your booking.');
          return;
      }
      ...
      showMessage('Your booking has been successfully submitted! We will review your payment proof shortly.');
